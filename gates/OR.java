//OR gate- Derived class of Gate 
package gates;
import exceptions.*;

public class OR<T extends Comparable> extends Gates
{
    ...
    public OR(int VCC, int gnd, int inputPinNo1,int inputPinNo2, int outputPinNo, T input1, T input2)
    {
