//EXOR gate- Derived class of Gate 
package gates;
import exceptions.*;

public class EXOR<T extends Comparable> extends Gates
{
    ...
    public EXOR(int VCC, int gnd, int inputPinNo1,int inputPinNo2, int outputPinNo, T input1, T input2)
    {
