//AND gate- Derived class of Gate 
package gates;
import exceptions.*;

public class AND<T extends Comparable> extends Gates
{
    ...
    public AND(int VCC, int gnd, int inputPinNo1,int inputPinNo2, int outputPinNo, T input1, T input2)
    {
    ...
    public String checkOutputPin()
    {
        ...
        {   
            if(inputCombos[outputPinNo]!=3)
                ...
                throw new OutputPinException("Wrong OutputPin-InputPin Combination\n");
        }
